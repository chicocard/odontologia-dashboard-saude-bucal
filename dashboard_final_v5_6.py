...
st.set_page_config(
    page_title="OdontoWorkforce Brasil — V5.6",
    page_icon="🦷",
    layout="wide",
...
st.markdown(
    ...
    <div class="ow-hero">
        ...
        <div class="ow-hero-subtitle">
            Painel V5.6 — força de trabalho odontológica, território, especialidades, vínculos e taxas per capita.
        </div>
...
# =============================================================================
# ANÁLISES INSPIRADAS NO BOLETIM TÉCNICO 07 — SAÚDE BUCAL
# =============================================================================
...
def categoria_saude_bucal(cbo_value: Any) -> str:
    """
    Classifica os CBOs no modelo analítico usado no Boletim Técnico 07:
...
with tabs[0]:
    st.markdown('<div class="ow-section-title">Síntese analítica inspirada no Boletim Técnico 07</div>', unsafe_allow_html=True)

    st.markdown(
        '<div class="ow-note">'
        'Esta página foi reorganizada segundo o modelo analítico do Boletim Técnico 07: composição da força de trabalho '
        'em Saúde Bucal, densidade por 10 mil habitantes, distribuição territorial e razão entre cirurgiões-dentistas '
        'e ocupações de apoio. Foram removidos os gráficos de número de municípios com vínculo e taxa agregada anual, '
        'que eram pouco informativos para esta finalidade.'
        '</div>',
        unsafe_allow_html=True,
    )
    ...
    if series_df.empty:
        ...
        st.warning("A síntese no padrão do Boletim 07 exige tabela territorial e população municipal.")
    else:
        ...
        # Densidade por UF e categoria, no modelo da Figura 3 do Boletim.
        uf_pop = (
        ...
        # Razões CD/TSB e CD/ASB, no modelo da Figura 6 do Boletim.
        uf_pivot = (
        ...
        st.markdown("### Tabela-súmula no padrão do Boletim 07")
...
with tabs[3]:
    ...
    st.markdown(
        ...
        'seguindo o modelo do Boletim Técnico 07.'
        '</div>',
        unsafe_allow_html=True,
    )
...
with tabs[7]:
    ...
    download_buttons(export_tables["serie_temporal"], "exportacao_geral_v5_6_2", export_tables)
...
st.markdown(
    '<div class="ow-footer">OdontoWorkforce Brasil V5.6 — painel experimental para análise de força de trabalho odontológica com RAIS, regiões de saúde e populações IBGE/TCU.</div>',
    unsafe_allow_html=True,
)
