...
st.set_page_config(
    page_title="OdontoWorkforce Brasil — V5.3",
    page_icon="🦷",
    layout="wide",
...
st.markdown(
    ...
    <div class="ow-hero">
        ...
        <div class="ow-hero-subtitle">
            Painel V5.3 — força de trabalho odontológica, território, especialidades, vínculos e taxas per capita.
        </div>
...
def municipio_code_diagnostics() -> pd.DataFrame:
    ...
    return sql_df(f"""
        SELECT
            ...
            COUNT(DISTINCT {norm_expr}) AS codigos_normalizados_distintos,
...
with tabs[7]:
    ...
    download_buttons(export_tables["serie_temporal"], "exportacao_geral_v5_3_2", export_tables)
...
st.markdown(
    '<div class="ow-footer">OdontoWorkforce Brasil V5.3 — painel experimental para análise de força de trabalho odontológica com RAIS, regiões de saúde e populações IBGE/TCU.</div>',
    unsafe_allow_html=True,
)
