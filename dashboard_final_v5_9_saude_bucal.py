...
st.set_page_config(
    page_title="OdontoWorkforce Brasil — V5.9 Saúde Bucal",
    page_icon="🦷",
    layout="wide",
...
st.markdown(
    ...
    <div class="ow-hero">
        ...
        <div class="ow-hero-subtitle">
            Painel V5.9 Saúde Bucal — composição ocupacional, densidades, território, vínculos e perfil sociodemográfico.
        </div>
...
with tabs[7]:
    ...
    download_buttons(export_tables["serie_temporal"], "exportacao_geral_v5_9_saude_bucal_2", export_tables)
...
st.markdown(
    '<div class="ow-footer">OdontoWorkforce Brasil V5.9 Saúde Bucal — painel experimental para análise de força de trabalho odontológica com RAIS, regiões de saúde e populações IBGE/TCU.</div>',
    unsafe_allow_html=True,
)
